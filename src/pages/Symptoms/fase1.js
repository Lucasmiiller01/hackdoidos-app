...
import InfoImg from "../../shared/imgs/hives.png"
  ...
  render() {
    return (
      <Container>
        ...
        <Text style={{color: "#4c88d6", textAlign: "center", fontSize: 22, marginTop: 20}}> Manchas vermelhas na pele ? </Text>
        <View style={{justifyContent: "center", alignItems: "center", marginTop:50}}>
          ...
          <View  style={{backgroundColor: "#4c88d6", borderRadius: 20, marginHorizontal: 20}}>
            ...
            <IconButton
              ...
              color={"#FFF"}
              size={50}
              onPress={() =>this.props.navigation.navigate({routeName: 'SymptomsScreen2'})}
            />
          </View>
